<?php
/**
 * Plugin Name: webmediavietnam
 * Description: widget for elementor
 * Plugin URI:  https://webmediavietnam.com/
 * Version:     1.0
 * Author:      Web Media Việt Nam
 * Author URI:  https://webmediavietnam.com/
