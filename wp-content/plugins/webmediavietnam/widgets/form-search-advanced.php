...
class Form_Search_Advanced extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Form Search Advanced', 'addon_elementor' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new Form_Search_Advanced() );